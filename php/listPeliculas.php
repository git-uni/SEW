...
<head>
    ...
    <meta charset="UTF-8" />
    <title>EscritorioVirtual: Listado Pelioculas</title>
    <meta name="author" content="Daniel Uria" />
    <meta name="description" content="Listado con las peliculas que figuran en la BD" />
    <meta name="keywords" content="Lista, Peliculas, BD" />
...
<body>
    ...
    $peliculas = $gestor->getTableInfo("pelicula");
    ?>
    ...
    <article>
        ...
        <ul>
            ...
            <?php foreach ($peliculas as $pelicula): ?>
                <li>
                    <?php echo "Nombre: " . $pelicula["nombre"] . ", Año estreno: " . $pelicula["añoEstreno"] . ", Genero:  " . $pelicula["genero"] . ", Ganancias: " .  $pelicula["ganancias"] . "$ , Productora: " . $pelicula["nombreProductora"] ?>
                </li>
            <?php endforeach; ?>
